    ...
    <div className="page-content fade-in">
      <div className="container">
        ...
        <section className="project-section">
          ...
          <br/>
          <p>
            &nbsp;&nbsp;&nbsp;&nbsp;Seja bem-vindo(a) ao Sinapse Digital. Meu nome é Giovanni, e este projeto é a culminação de anos de estudo, algumas noites em claro e, acima de tudo, de uma profunda crença de que a tecnologia pode e deve servir como uma força para o bem-estar humano.
          </p>
          <hr></hr>
          <h3>A Motivação</h3>
          <p>
